...
write.table(res_wMedian, file="Statin_wMedian_0806.csv", col.names=TRUE, row.names=FALSE, sep=",")

# Perform Single SNP MR If interested in single snp analysis
res_single <- mr_singlesnp(dat, all_method="mr_weighted_median")
res_single
write.csv(res_single, "Statin_SingleSNP_Proteomics.csv", row.names=FALSE)
